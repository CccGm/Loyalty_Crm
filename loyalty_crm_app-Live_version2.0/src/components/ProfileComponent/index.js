...
const ProfileComponent = ({
  ...
  const onShare = async code => {
    const link = 'https://theeyebrowcity.gosolutions.sg/admin/store/85';
    // const link = await dynamicLinks().buildShortLink({
    //   link: `https://theeyebrowcity.gosolutions.sg/?invitedBy=${code}`,
    //   domainUriPrefix: `https://eyebrowcity.page.link`, // The prefix for your dynamic link URL
    //   android: {
    //     packageName: 'sg.co.gosolution.loyaltycrm', // Your Android package name
    //   },
    //   ios: {
    //     bundleId: 'sg.co.gosolution.lcrm.eyebrow', // Your iOS bundle identifier
    //     appStoreId: '6443499732',
    //   },
    //   suffix: {
    //     option: 'SHORT',
    //   },
    ...
    <Container>
      ...
      <RBSheet
        ...
        {/* <View
          ...
          <Barcode
            value={
              profiledata.data == '' ? '0' : profiledata.data.membership_code
            }
            format="CODE128"
            width={2}
            height={50}
