...
const ServiceComponent = ({ActiveItemClick, historyItemClick}) => {
  ...
  console.log(
    'profilestatesddmkdaksdskmdsak',
    profileState.data.membership_code,
  );
  console.log('first_name', profileState.data.first_name);
  console.log('last_name', profileState.data.last_name);
  const idex = data => {
