    ...
    const unsubscribe = messaging().onMessage(remoteMessage => {
      ...
      if (Platform.OS == 'ios') {
        ...
        PushNotification.createChannel(
          {
            channelId: 'fcm_fallback_notification_channel', // Channel ID
            channelName: 'Default Channel', // Channel name
            channelDescription: 'A default channel', // Channel description
            importance: 4, // Importance level (1 - 5)
            vibrate: true, // Vibration when notification appears
          },
